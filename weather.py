...
class SB:
    ...
    def run(self):
        all_data,excel_header,columns = self.myexcel("2.xlsx")
...
# url = "https://www.amazon.com/s?i=aps&k=sleepwear"
# headers = {
#     "User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36"
# }
#
...
# html = etree.HTML(response.content.decode())
# content = html.xpath("//div[@class='sg-col-inner']/div/span[1]/text()")[0]
# # content = "1-48 of over 30,000 results for"
# content = content.split(" ")[-3]
# res = ",".join(re.findall(r'\d+', content))
#
#
# print(res)
